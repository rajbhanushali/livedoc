...
prompt = (f"""
You are a youth basketball analyst. The data in this table represents the top performers from the EYBL tournament. The tournament has {total_players} total players. Can you take this table and describe the top players performances relative to the averages
